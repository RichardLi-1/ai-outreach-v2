    ...
    def main(self, run_id):
        try:
            ...
            for sheet_name, df in sheets.items():
                secs = utilities._split_by_duplicate_headers(df, sheet_name, self.logger)
            ...
            for sheet_name, df in sheets.items():
                ...
                for section_idx, (section_name, section_df) in enumerate(sections, start=1):
                    ...
                    cols, self.cols = utilities._detect_columns(df)
                    ...
                    if state_col and state_col in df.columns:
                        ...
                        if not non_null.empty:
                            ...
                            _normalized = _state_map.get(state_val.lower(), None) or _state_map.get(state_val.lower()[0:2], state_val)
                            if " – " in _normalized:
